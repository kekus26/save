...
function startTetris() {
    ...
    // возвращает рандомное значение (номер фигуры)
    ...
    function createFigure() {
        ...
        rotate = 1;
        currentFigure = counters < 4 ? randomIndex(mainArr) : randomIndex(customFigure);
        ...
        figureBody = counters < 4 ?
            ...
            document.querySelector(`[posX = "${x + mainArr[currentFigure][3][0]}"][posY = "${y + mainArr[currentFigure][3][1]}"]`),
            ]
        :
            [
    ...
    window.addEventListener('keydown', function (e) {
        ...
        if (e.keyCode == 37) {
            ...
            let figureNew = counters < 4 ?
                [
                    document.querySelector(`[posX = "${+coordinates[0][0] + mainArr[currentFigure][rotate + 3][0][0]}"][posY = "${+coordinates[0][1] + mainArr[currentFigure][rotate + 3][0][1]}"]`),
                    document.querySelector(`[posX = "${+coordinates[1][0] + mainArr[currentFigure][rotate + 3][1][0]}"][posY = "${+coordinates[1][1] + mainArr[currentFigure][rotate + 3][1][1]}"]`),
                    document.querySelector(`[posX = "${+coordinates[2][0] + mainArr[currentFigure][rotate + 3][2][0]}"][posY = "${+coordinates[2][1] + mainArr[currentFigure][rotate + 3][2][1]}"]`),
                    document.querySelector(`[posX = "${+coordinates[3][0] + mainArr[currentFigure][rotate + 3][3][0]}"][posY = "${+coordinates[3][1] + mainArr[currentFigure][rotate + 3][3][1]}"]`),
                ]
            :
                [
